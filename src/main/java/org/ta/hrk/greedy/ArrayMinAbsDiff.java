...
we can create pairs of numbers: and . The absolute differences for these pairs are , and . The minimum absolute difference is
...
With
integers in our array, we have three possible pairs: , , and
